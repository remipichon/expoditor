TurnManager = function() {
    this.turnIsInit = false;
};



//initTurn
TurnManager.prototype.initSlideshow = function() {
    $("#turn-container").turn({
...
//createTurnPage
TurnManager.prototype.initSlideshow.createSlide = function(_id) {
...
//deleteTurnPage
TurnManager.prototype.deleteTurnPage = function(_id) {
    logger.debug("deleteTurnPage", _id);
    var page = Slides.findOne({
        _id: _id
    });
...
Template.turnContainer.slides = function() {
    ...
    logger.info("Template.turnContainer.slides  inject data");
    return Slides.find({}, {
        sort: {
            order: 1
        },
